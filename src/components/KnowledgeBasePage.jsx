...
export function KnowledgeBasePage({ performers, performerState = "ready", performerMessage = "", onRetryPerformers, quickAccess, onSectionChange, onSavePerformer, onToggleQuickAccess, onDeletePerformer }) {
  ...
  return <div className="kb-root">
    <AppTopNavigation activeSection="knowledgeBase" onSectionChange={onSectionChange} edge hideAccountActions />
