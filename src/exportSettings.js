...
export const EXPORT_LOGO_POSITIONS = Object.freeze(["left", "center", "right"]);
export const DEFAULT_PRESENTATION_SETTINGS = Object.freeze({
  branding: { logoAssetPath: "", logoPosition: "left", companyPosition: "left", companyName: "", phone: "", email: "", website: "", colors: { header: "#F7FAFC", headerText: "#64748B", stage: "#EEF2F7", task: "#FFFFFF", total: "#E8EEF7", stageText: "#1A2230", taskText: "#1A2230", totalText: "#1A2230", accent: "#1A2230", text: "#1A2230" }, headerFontSize: 10, fontFamily: "Roboto" },
...
export function normalizePresentationSettings(value) {
  ...
  return {
    branding: { logoAssetPath: text(brand.logoAssetPath), logoPosition: EXPORT_LOGO_POSITIONS.includes(brand.logoPosition) ? brand.logoPosition : defaults.branding.logoPosition, companyPosition: EXPORT_LOGO_POSITIONS.includes(brand.companyPosition) ? brand.companyPosition : defaults.branding.companyPosition, companyName: text(brand.companyName, text(brand.studioName)), phone: text(brand.phone), email: text(brand.email), website: text(brand.website), colors: { header: color(colors.header, defaults.branding.colors.header), headerText: color(colors.headerText, defaults.branding.colors.headerText), stage: color(colors.stage, defaults.branding.colors.stage), task: color(colors.task, defaults.branding.colors.task), total: color(colors.total, defaults.branding.colors.total), stageText: color(colors.stageText, defaults.branding.colors.stageText), taskText: color(colors.taskText, defaults.branding.colors.taskText), totalText: color(colors.totalText, defaults.branding.colors.totalText), accent: color(colors.accent, defaults.branding.colors.accent), text: color(colors.text, defaults.branding.colors.text) }, headerFontSize: size(brand.headerFontSize ?? colors.headerFontSize, defaults.branding.headerFontSize), fontFamily: EXPORT_FONT_FAMILIES.includes(brand.fontFamily) ? brand.fontFamily : defaults.branding.fontFamily },
