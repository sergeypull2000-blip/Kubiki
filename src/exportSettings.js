...
export const DEFAULT_PRESENTATION_SETTINGS = Object.freeze({
  ...
  content: { showComments: false, performerVisibility: "none", visibleExecutorIds: [], rowColorOverrides: {} },
...
export function normalizePresentationSettings(value) {
  ...
  return {
    ...
    content: { showComments: content.showComments === true, performerVisibility: "none", visibleExecutorIds: [], rowColorOverrides: Object.fromEntries(Object.entries(object(content.rowColorOverrides)).filter(([, value]) => /^#[0-9a-f]{6}$/i.test(value))) },
