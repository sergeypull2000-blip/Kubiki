...
.kb-export-preview{margin:0;min-height:100%;overflow:hidden;border:1px solid var(--line);border-radius:8px;background:var(--surface)}.kb-export-preview-stage{display:flex;flex-direction:column}.kb-export-preview-task{display:flex;flex-direction:column}.kb-export-preview-task+.kb-export-preview-task{border-top:1px solid var(--line)}.kb-export-preview-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;padding:7px 10px}.kb-export-preview-row:has(.kb-export-preview-comment){grid-template-columns:minmax(0,1fr) minmax(120px,.6fr) auto}.kb-export-preview-separate{display:flex;justify-content:space-between;gap:16px;padding:7px 10px;color:var(--text-muted);font-size:12px}.kb-export-preview-total{display:flex;justify-content:space-between;gap:16px;padding:7px 10px;font-size:13px;border-top:1px solid var(--line)}.kb-export-warning,.kb-export-error{margin:10px;padding:8px 10px;border-radius:7px;background:#fff7df;color:#735b18;font-size:11px}.kb-export-error{margin:10px 0 0;background:#fff0ef;color:#9f2e25}
