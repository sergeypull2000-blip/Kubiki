...
.kb-ai-settings-modal .kb-ai-history-option{box-sizing:border-box;min-height:92px;align-items:flex-start}.kb-ai-settings-modal .kb-ai-history-option>span{display:flex;flex:1;flex-direction:column;gap:3px}.kb-ai-settings-modal .kb-ai-history-option small{display:block}.kb-ai-settings-modal .kb-ai-history-option a,.kb-ai-improvement-option a{color:var(--accent);text-decoration:none}.kb-ai-improvement-option{display:flex;align-items:flex-start;gap:9px;margin:4px 0 12px;padding:12px;border:1px solid var(--line);border-radius:8px}.kb-ai-improvement-option>span{display:flex;flex-direction:column;gap:4px}.kb-ai-improvement-option small{color:var(--text-muted);line-height:1.45}
`;
