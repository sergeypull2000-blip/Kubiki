...
.kb-template-name-input{flex:1;min-width:0}.kb-onboarding-modal{width:min(620px,calc(100vw - 32px));max-height:min(760px,calc(100vh - 32px));overflow:auto}.kb-onboarding-modal .kb-modal-title{display:flex;align-items:center;gap:9px}.kb-onboarding-content{display:flex;flex-direction:column;gap:18px;padding:20px 24px 8px}.kb-onboarding-lead{margin:0;color:var(--accent);font-size:15px;font-weight:var(--fw-semibold)}.kb-onboarding-content section{padding:0}.kb-onboarding-content h3{margin:0 0 5px;font-size:14px;line-height:1.35}.kb-onboarding-content p{margin:0;color:var(--text-muted);font-size:13px;line-height:1.5}.kb-export-format{display:flex;align-items:center;gap:5px;padding:8px 10px;border:1px solid var(--line);border-radius:7px}.kb-export-format>span{margin-right:auto;color:var(--text-muted);font-size:12px}.kb-export-format button{min-width:62px;padding:6px 10px;border:1px solid var(--line);border-radius:6px;background:var(--surface);color:var(--text-muted);font:inherit;cursor:pointer}.kb-export-format button.is-active{border-color:var(--accent);background:var(--accent-soft);color:var(--accent);font-weight:600}@media(max-width:650px){.kb-onboarding-content{gap:16px;padding:18px 20px 6px}}
.kb-onboarding-content{padding-bottom:20px}
.kb-onboarding-modal>.kb-modal-actions{margin-top:0;padding:0 24px 20px}
@media(max-width:650px){.kb-onboarding-modal>.kb-modal-actions{padding-inline:20px}}
`;
