...
.kb-export-brand-row{display:grid;grid-template-columns:minmax(0,1fr) 244px;align-items:center;gap:10px}.kb-export-brand-label{grid-column:1 / -1;font-size:var(--fs-xs);font-weight:var(--fw-semibold);color:var(--text-muted)}.kb-export-brand-row .kb-export-logo-row{min-width:0}.kb-export-brand-row .kb-export-field-stacked{min-width:0}.kb-brand-remove{display:grid;place-items:center;width:24px;height:24px;padding:0;border:1px solid var(--line);border-radius:6px;background:var(--surface);color:var(--text-muted);font-size:17px;line-height:1;cursor:pointer}.kb-brand-remove:hover:not(:disabled){border-color:#c53b32;background:#fff5f4;color:#b42318}.kb-brand-remove:disabled{opacity:.55;cursor:not-allowed}.kb-position-segmented{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));height:30px;min-width:0}.kb-position-segmented button{min-width:0;padding:0 7px;border:1px solid var(--line);border-right:0;background:var(--surface);color:var(--text-muted);font:inherit;font-size:var(--fs-xs);white-space:nowrap;cursor:pointer}.kb-position-segmented button:first-child{border-radius:5px 0 0 5px}.kb-position-segmented button:last-child{border-right:1px solid var(--line);border-radius:0 5px 5px 0}.kb-position-segmented button:hover{background:var(--accent-soft);color:var(--text)}.kb-position-segmented button.is-active{border-color:var(--accent);background:var(--accent-soft);color:var(--text);font-weight:var(--fw-semibold);box-shadow:inset 0 0 0 1px var(--accent)}
