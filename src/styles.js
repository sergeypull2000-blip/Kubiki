...
.kb-export-modal-actions{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:14px 18px}.kb-export-modal-action-buttons{display:flex;justify-content:flex-end;align-items:center;gap:8px}.kb-export-modal-actions .kb-export-go2{width:auto;margin:0}.kb-export-modal-actions .kb-export-format{flex:none}
