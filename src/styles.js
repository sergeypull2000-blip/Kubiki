/* ============================================================
   ...
   ============================================================ */
export const CSS = `
.kb-server-screen{min-height:100vh;display:flex;align-items:center;justify-content:center;background:#f7f7f7;padding:24px}.kb-server-card{width:min(440px,calc(100vw - 32px));padding:24px;background:#fff;border:1px solid #ddd;border-radius:10px;box-shadow:0 12px 40px rgba(0,0,0,.08)}.kb-server-title{font-size:18px;font-weight:600;margin-bottom:10px}.kb-server-text{font-size:14px;line-height:1.55;color:#666}.kb-server-error{margin-top:10px;color:#315f8c;background:#eef6ff;border:1px solid #cfe3f7;border-radius:6px;padding:8px 10px;font-size:13px}.kb-server-overlay{z-index:1000}.kb-save-status{display:flex;align-items:center;gap:7px;font-size:11px;color:#888;white-space:nowrap}.kb-save-status.is-error{color:#315f8c}.kb-save-status button,.kb-toast-retry{border:0;background:none;padding:0;color:inherit;text-decoration:underline;cursor:pointer}.kb-toast-retry{margin-left:8px}
:root{
  --bg:#FCFDFE;
  --bg-elevated:#FEFEFF;
  --surface:#FFFFFF;
...
.kb-sidebar-actions{position:absolute;z-index:3;left:25px;right:14px;bottom:calc(100% + 12px);display:flex;align-items:center;justify-content:space-between;gap:16px}.kb-feedback-float{display:grid;place-items:center;width:auto;height:45px;padding:0 16px;border:0;border-radius:12px;background:linear-gradient(145deg,#2ea3ff,#2698ff);color:#fff;font:inherit;font-size:13px;font-weight:600;white-space:nowrap;box-shadow:0 10px 24px rgba(38,152,255,.3);cursor:pointer;transition:box-shadow .18s ease,background .15s ease,filter .15s ease}.kb-help-button{display:grid;flex:0 0 auto;place-items:center;width:38px;height:38px;padding:0;border:1px solid var(--line-strong);border-radius:11px;background:var(--surface);color:var(--text-muted);font:inherit;font-size:17px;font-weight:700;box-shadow:0 8px 20px rgba(24,38,67,.12);cursor:pointer}.kb-help-button:hover{border-color:var(--accent);color:var(--accent);background:var(--accent-soft)}
...
.kb-export-modal-actions{display:flex;justify-content:flex-end;align-items:center;gap:8px;padding:14px 18px}.kb-export-modal-action-buttons{display:flex;justify-content:flex-end;align-items:center;gap:8px}.kb-export-modal-actions .kb-export-go2{width:auto;margin:0}.kb-export-format-picker{position:relative;flex:none}.kb-export-format-trigger{display:inline-flex;align-items:center;gap:7px;min-height:31px;padding:0 10px;border:1px solid var(--line);border-radius:6px;background:var(--surface);color:var(--text);font:inherit;font-size:var(--fs-sm);cursor:pointer}.kb-export-format-trigger:hover{border-color:var(--line-strong);background:var(--surface-sunken)}.kb-export-format-trigger:focus-visible,.kb-export-format-menu button:focus-visible{outline:2px solid var(--accent);outline-offset:2px}.kb-export-format-menu{position:absolute;right:0;bottom:calc(100% + 6px);z-index:50;display:flex;flex-direction:column;min-width:100%;padding:4px;border:1px solid var(--line-strong);border-radius:7px;background:var(--surface);box-shadow:0 12px 30px rgba(20,30,50,.18)}.kb-export-format-menu button{display:block;padding:7px 10px;border:0;border-radius:4px;background:transparent;color:var(--text);font:inherit;font-size:var(--fs-sm);text-align:left;white-space:nowrap;cursor:pointer}.kb-export-format-menu button:hover,.kb-export-format-menu button.is-active{background:var(--accent-soft);color:var(--text)}
...
.kb-usage-modal{width:min(540px,92vw);max-width:min(540px,92vw);border-radius:10px}
.kb-usage-modal-head{padding:15px 19px 10px;border-bottom:0}.kb-usage-modal-head .kb-modal-title{font-size:18px;letter-spacing:-.02em}
.kb-usage-close{display:grid;place-items:center;width:22px;height:22px;padding:0;border:0;background:transparent;color:#7d8aa3;font:300 25px/1 Arial,sans-serif;cursor:pointer}.kb-usage-close:hover{color:var(--text)}.kb-usage-close:focus-visible{outline:2px solid var(--accent);outline-offset:2px;border-radius:4px}
.kb-usage-modal .kb-modal-body{padding:5px 19px 10px;overflow:visible;flex:none;min-height:61px}
.kb-usage-bar{height:10px;border-radius:999px;background:#e8edf7;overflow:hidden}.kb-usage-bar-fill{height:100%;background:#4265ed;border-radius:999px;transition:width .3s ease}
.kb-usage-figures{display:flex;align-items:center;gap:18px;margin-top:17px}.kb-usage-figures strong{font-size:22px;line-height:1;letter-spacing:-.035em}.kb-usage-figures strong em{font-size:12px;font-style:normal;font-weight:var(--fw-regular);letter-spacing:0}.kb-usage-reset{min-height:22px;display:flex;align-items:center;padding-left:17px;border-left:1px solid var(--line);color:#77849b;font-size:12px;line-height:1.35}.kb-usage-pending{color:#77849b;font-size:12px;line-height:1.45}.kb-usage-figures.is-cycle-pending{align-items:flex-start}.kb-usage-figures.is-cycle-pending strong{padding-top:2px}
.kb-usage-modal-foot{justify-content:flex-end;padding:13px 19px 16px;border-top:1px solid var(--line)}.kb-usage-modal-foot .kb-btn{justify-content:center;min-width:83px;height:31px;min-height:0;padding:1px 12px 0;font-size:12px;line-height:1;text-align:center}
@media(max-width:520px){.kb-usage-modal-head{padding:20px 20px 12px}.kb-usage-modal .kb-modal-body{padding:8px 20px 20px}.kb-usage-figures{align-items:flex-start;flex-direction:column;gap:14px;margin-top:20px}.kb-usage-reset{min-height:0;padding-left:0;border-left:0}.kb-usage-modal-foot{padding:18px 20px}}
.kb-ai-edit-error{margin-top:10px;color:#2563eb;font-size:13px}
.kb-export-brand-row{grid-template-columns:minmax(0,1fr) 244px;gap:8px 10px}.kb-export-brand-label{grid-column:1 / -1;font-weight:400}.kb-export-brand-row .kb-export-logo-row,.kb-export-company-input{grid-column:1}.kb-position-segmented{grid-column:2}
.kb-position-segmented button{flex:1 1 0;box-sizing:border-box}
.kb-export-brand-row{display:grid;grid-template-columns:112px minmax(0,1fr) 244px;align-items:center;gap:10px}.kb-export-brand-label{font-size:var(--fs-xs);font-weight:var(--fw-semibold);color:var(--text-muted);white-space:nowrap}.kb-export-brand-row .kb-export-logo-row,.kb-export-company-input{grid-column:2;min-width:0}.kb-export-company-input{width:100%;box-sizing:border-box;padding:6px 8px;border:1px solid var(--line);border-radius:4px;background:var(--surface)}.kb-brand-remove{display:grid;place-items:center;width:24px;height:24px;padding:0;border:1px solid var(--line);border-radius:6px;background:var(--surface);color:var(--text-muted);font-size:17px;line-height:1;cursor:pointer}.kb-brand-remove:hover:not(:disabled){border-color:#c53b32;background:#fff5f4;color:#b42318}.kb-brand-remove:focus-visible{outline:2px solid var(--accent);outline-offset:2px}.kb-brand-remove:disabled{opacity:.55;cursor:not-allowed}.kb-position-segmented{grid-column:3;display:flex;align-items:center;gap:5px;height:30px;min-width:0}.kb-position-segmented button{flex:1;min-width:0;height:30px;padding:0 7px;border:1px solid var(--line);border-radius:5px;background:var(--surface);color:var(--text-muted);font:inherit;font-size:var(--fs-xs);white-space:nowrap;cursor:pointer}.kb-position-segmented button:hover{background:var(--accent-soft);color:var(--text)}.kb-position-segmented button:focus-visible{outline:2px solid var(--accent);outline-offset:1px}.kb-position-segmented button.is-active{border-color:var(--accent);background:var(--accent-soft);color:var(--text)}
.kb-template-tree-file{cursor:pointer}.kb-template-tree-file span{user-select:text;cursor:text}.kb-template-drag-handle{flex:none;border:0;background:transparent;color:var(--text-faint);cursor:grab;padding:0 2px;font-size:14px}.kb-dropdown{position:relative}.kb-dropdown-trigger{display:flex;align-items:center;justify-content:space-between;gap:8px;width:100%;min-height:29px;padding:6px 8px;border:1px solid var(--line);border-radius:4px;background:var(--surface);color:var(--text);font:inherit;cursor:pointer}.kb-dropdown-menu{position:absolute;z-index:30;top:calc(100% + 4px);left:0;right:0;padding:4px;background:var(--surface);border:1px solid var(--line-strong);border-radius:6px;box-shadow:0 8px 24px rgba(20,30,50,.14)}.kb-dropdown-menu button{display:block;width:100%;padding:6px 8px;border:0;border-radius:4px;background:transparent;text-align:left;color:var(--text);font:inherit;cursor:pointer}.kb-dropdown-menu button:hover,.kb-dropdown-menu button.is-active{background:var(--accent-soft)}.kb-export-preview-brand{display:grid;grid-template-columns:1fr 1fr 1fr;align-items:stretch;gap:16px}.kb-export-preview-brand>span{display:flex;align-items:center;gap:10px;min-width:0}.kb-export-preview-brand>span:nth-child(2){justify-content:center}.kb-export-preview-brand>span:nth-child(3){justify-content:flex-end}

.kb-export-brand-row .kb-export-logo-row{grid-column:1}.kb-export-brand-row .kb-export-company-input{grid-column:1 / span 2}
.kb-position-segmented button{display:grid;place-items:center;flex:1 1 0;min-width:0;box-sizing:border-box;padding:0 7px;text-align:center;font-weight:var(--fw-regular)}
.kb-position-segmented{width:calc(100% + 4px)}.kb-position-segmented button{flex:0 0 calc((100% - 14px) / 3)}.kb-position-segmented button:nth-child(2){flex-basis:calc((100% - 14px) / 3 + 4px)}
.kb-auth-consent{display:flex;align-items:flex-start;gap:9px;color:var(--text-muted);font-size:12px;line-height:1.45}.kb-auth-consent input{flex:none;margin-top:2px}.kb-auth-consent a,.kb-auth-privacy,.kb-legal-link,.kb-legal-back{color:var(--accent);text-decoration:none}.kb-auth-consent a:hover,.kb-auth-privacy:hover,.kb-legal-link:hover,.kb-legal-back:hover{text-decoration:underline}.kb-auth-privacy{font-size:12px}
.kb-legal-page{min-height:100vh;background:#f6f8fc;padding:44px 20px;color:var(--text)}.kb-legal-document{box-sizing:border-box;width:min(800px,100%);margin:0 auto;padding:40px 48px;border:1px solid var(--line);border-radius:12px;background:var(--surface);box-shadow:0 12px 36px rgba(20,30,50,.06)}.kb-legal-document h1{margin:22px 0 4px;font-size:30px;line-height:1.15}.kb-legal-version{margin:0 0 32px;color:var(--text-muted);font-size:13px}.kb-legal-document h2,.kb-legal-document h3{margin:26px 0 8px;font-size:17px}.kb-legal-document p{margin:0 0 14px;color:#3f495c;font-size:15px;line-height:1.65}.kb-legal-document ul{margin:0 0 16px;padding-left:24px;color:#3f495c;font-size:15px;line-height:1.65}.kb-ai-disclosure{width:min(560px,92vw)}.kb-ai-disclosure p{margin:0 0 14px;line-height:1.55}.kb-ai-disclosure .kb-legal-link{display:inline-block;margin-bottom:12px}.kb-ai-result-label{margin-top:10px;color:var(--text-faint);font-size:11px;line-height:1.4}@media(max-width:600px){.kb-legal-page{padding:0}.kb-legal-document{min-height:100vh;padding:28px 22px;border:0;border-radius:0}.kb-legal-document h1{font-size:25px}}
.kb-ai-settings-modal .kb-ai-history-option{box-sizing:border-box;min-height:92px;align-items:flex-start}.kb-ai-settings-modal .kb-ai-history-option:nth-of-type(-n+2){min-height:46px;margin-top:9px;padding:8px 10px}.kb-ai-settings-modal .kb-ai-history-option>span{display:flex;flex:1;flex-direction:column;gap:3px}.kb-ai-settings-modal .kb-ai-history-option small{display:block}.kb-ai-settings-modal .kb-ai-history-option a,.kb-ai-improvement-option a{color:var(--accent);text-decoration:none}.kb-ai-improvement-option{display:flex;align-items:flex-start;gap:9px;margin:4px 0 12px;padding:12px;border:1px solid var(--line);border-radius:8px}.kb-ai-improvement-option>span{display:flex;flex-direction:column;gap:4px}.kb-ai-improvement-option small{color:var(--text-muted);line-height:1.45}
.kb-template-name-input{flex:1;min-width:0}.kb-onboarding-modal{width:min(800px,calc(100vw - 32px));max-height:min(820px,calc(100vh - 32px));overflow:hidden}.kb-onboarding-content{min-height:0;overflow-y:auto;padding:32px 56px 10px}.kb-onboarding-brand{display:flex;align-items:center;justify-content:space-between;min-height:22px}.kb-onboarding-title{margin:16px 0 0;color:var(--text);font-size:27px;line-height:1.18;letter-spacing:-.025em}.kb-onboarding-sections{display:flex;flex-direction:column;gap:25px;max-width:680px;margin-top:32px}.kb-onboarding-sections section{padding:0}.kb-onboarding-sections h2{margin:0 0 7px;color:var(--text);font-size:15px;line-height:1.35;font-weight:var(--fw-semibold)}.kb-onboarding-sections p{margin:0;color:var(--text-muted);font-size:14px;line-height:1.62}.kb-onboarding-modal>.kb-modal-actions{flex-shrink:0;margin-top:0;padding:22px 56px 30px}.kb-onboarding-close{flex:none}@media(max-width:650px){.kb-onboarding-content{padding:24px 24px 8px}.kb-onboarding-title{font-size:24px}.kb-onboarding-sections{gap:21px;margin-top:26px}.kb-onboarding-modal>.kb-modal-actions{padding:18px 24px 24px}}
`;
