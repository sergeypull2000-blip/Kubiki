...
.kb-usage-modal{width:min(810px,92vw);max-width:min(810px,92vw);border-radius:15px}
.kb-usage-modal-head{padding:27px 28px 18px;border-bottom:0}.kb-usage-modal-head .kb-modal-title{font-size:23px;letter-spacing:-.02em}
.kb-usage-close{display:grid;place-items:center;width:28px;height:28px;padding:0;border:0;background:transparent;color:#7d8aa3;font:300 32px/1 Arial,sans-serif;cursor:pointer}.kb-usage-close:hover{color:var(--text)}.kb-usage-close:focus-visible{outline:2px solid var(--accent);outline-offset:2px;border-radius:4px}
.kb-usage-modal .kb-modal-body{padding:10px 28px 23px;overflow:visible;flex:none;min-height:91px}
.kb-usage-bar{height:14px;border-radius:999px;background:#e8edf7;overflow:hidden}.kb-usage-bar-fill{height:100%;background:#4265ed;border-radius:999px;transition:width .3s ease}
.kb-usage-figures{display:flex;align-items:center;gap:26px;margin-top:25px}.kb-usage-figures strong{font-size:32px;line-height:1;letter-spacing:-.035em}.kb-usage-figures strong em{font-size:16px;font-style:normal;font-weight:var(--fw-regular);letter-spacing:0}.kb-usage-reset{min-height:32px;display:flex;align-items:center;padding-left:25px;border-left:1px solid var(--line);color:#77849b;font-size:16px;line-height:1.35}.kb-usage-pending{color:#77849b;font-size:16px;line-height:1.45}.kb-usage-figures.is-cycle-pending{align-items:flex-start}.kb-usage-figures.is-cycle-pending strong{padding-top:3px}
.kb-usage-modal-foot{justify-content:flex-end;padding:24px 28px;border-top:1px solid var(--line)}.kb-usage-modal-foot .kb-btn{min-width:124px;min-height:46px;font-size:16px}
