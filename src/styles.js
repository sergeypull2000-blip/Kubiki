...
.kb-sidebar-actions{position:absolute;z-index:3;left:25px;bottom:calc(100% + 12px);display:flex;align-items:center;gap:7px}.kb-feedback-float{display:grid;place-items:center;width:auto;height:45px;padding:0 16px;border:0;border-radius:12px;background:linear-gradient(145deg,#2ea3ff,#2698ff);color:#fff;font:inherit;font-size:13px;font-weight:600;white-space:nowrap;box-shadow:0 10px 24px rgba(38,152,255,.3);cursor:pointer;transition:box-shadow .18s ease,background .15s ease,filter .15s ease}.kb-help-button{display:grid;place-items:center;width:38px;height:38px;padding:0;border:1px solid var(--line-strong);border-radius:11px;background:var(--surface);color:var(--text-muted);font:inherit;font-size:17px;font-weight:700;box-shadow:0 8px 20px rgba(24,38,67,.12);cursor:pointer}.kb-help-button:hover{border-color:var(--accent);color:var(--accent);background:var(--accent-soft)}
...
.kb-template-name-input{flex:1;min-width:0}.kb-onboarding-modal{width:min(650px,calc(100vw - 32px))}.kb-onboarding-modal .kb-modal-title{display:flex;align-items:center;gap:9px}.kb-onboarding-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:16px 20px 8px}.kb-onboarding-grid section{padding:12px;border:1px solid var(--line);border-radius:9px;background:var(--surface-sunken)}.kb-onboarding-grid h3{margin:0 0 5px;font-size:14px}.kb-onboarding-grid p{margin:0;color:var(--text-muted);font-size:12.5px;line-height:1.45}.kb-onboarding-shortcuts{display:flex;flex-direction:column;gap:6px;margin:4px 20px 0;padding:12px;border-radius:9px;background:var(--accent-soft);font-size:12px;color:var(--text-muted)}.kb-onboarding-shortcuts strong{color:var(--text)}.kb-onboarding-shortcuts kbd{padding:2px 5px;border:1px solid var(--line-strong);border-radius:4px;background:var(--surface);color:var(--text);font:inherit;font-size:11px}.kb-export-format{display:flex;align-items:center;gap:5px;padding:8px 10px;border:1px solid var(--line);border-radius:7px}.kb-export-format>span{margin-right:auto;color:var(--text-muted);font-size:12px}.kb-export-format button{min-width:62px;padding:6px 10px;border:1px solid var(--line);border-radius:6px;background:var(--surface);color:var(--text-muted);font:inherit;cursor:pointer}.kb-export-format button.is-active{border-color:var(--accent);background:var(--accent-soft);color:var(--accent);font-weight:600}@media(max-width:650px){.kb-onboarding-grid{grid-template-columns:1fr}}
`;
