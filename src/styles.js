...
.kb-palette-title{width:100%; display:flex; align-items:center; justify-content:space-between; background:none; border:none;
  cursor:pointer; padding:8px 6px; font-size:11px; font-weight:var(--fw-semibold); text-transform:none; letter-spacing:normal; color:var(--text)}
...
.kb-sum-stage{font-size:15px; font-weight:var(--fw-semibold); color:var(--text); letter-spacing:-.01em; min-width:104px}
...
.kb-stage-title-text{font-size:15.5px; font-weight:var(--fw-semibold); letter-spacing:-.01em}
...
.kb-props-section-title,.kb-props-sub-toggle{width:100%;display:flex;align-items:center;justify-content:space-between;background:none;border:none;padding:0;margin:2px 0 5px;font-size:11px;font-weight:var(--fw-semibold);text-transform:none;letter-spacing:normal;color:var(--text);text-align:left}.kb-props-section-toggle,.kb-props-sub-toggle{cursor:pointer;margin-top:16px}.kb-props-section-toggle:hover,.kb-props-sub-toggle:hover{color:var(--text)}.kb-props-row-nested span:first-child{padding-left:8px;color:var(--text-faint)}
...
.kb-export-modal{width:min(1120px,calc(100vw - 32px));height:min(760px,calc(100vh - 48px));display:flex;flex-direction:column;overflow:hidden;border:1px solid var(--line);border-radius:12px;background:var(--surface);box-shadow:0 24px 70px rgba(20,30,50,.24)}
...
.kb-export-modal-body{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(360px,1fr);min-height:0;flex:1}.kb-export-preview-pane{min-width:0;overflow:auto;padding:18px;background:var(--surface-sunken);border-right:1px solid var(--line)}.kb-export-settings-pane{min-width:0;overflow-y:auto;padding:14px}.kb-export-branding{margin:0 0 12px;padding:14px;border:1px solid var(--line);border-radius:9px;background:var(--surface-sunken);display:flex;flex-direction:column;gap:10px}.kb-export-branding .kb-brand-row{align-items:center}.kb-export-branding .kb-brand-input{flex:1;box-sizing:border-box}.kb-export-branding .kb-brand-actions{margin-top:2px}
...
.kb-export-preview{margin:0;min-height:100%;overflow:hidden;border:1px solid var(--line);border-radius:8px;background:var(--surface)}.kb-export-preview-stage{display:flex;flex-direction:column}.kb-export-preview-task{display:flex;flex-direction:column}.kb-export-preview-task+.kb-export-preview-task{border-top:1px solid var(--line)}.kb-export-preview-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;padding:7px 10px}.kb-export-preview-row:has(.kb-export-preview-comment){grid-template-columns:minmax(0,1fr) auto minmax(120px,.6fr)}.kb-export-preview-separate{display:flex;justify-content:space-between;gap:16px;padding:7px 10px;color:var(--text-muted);font-size:12px}.kb-export-preview-total{display:flex;justify-content:space-between;gap:16px;padding:7px 10px;font-size:13px;border-top:1px solid var(--line)}.kb-export-warning,.kb-export-error{margin:10px;padding:8px 10px;border-radius:7px;background:#fff7df;color:#735b18;font-size:11px}.kb-export-error{margin:10px 0 0;background:#fff0ef;color:#9f2e25}
