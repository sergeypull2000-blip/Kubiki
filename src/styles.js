...
.kb-usage-modal-head{padding:18px 19px 12px;border-bottom:0}.kb-usage-modal-head .kb-modal-title{font-size:18px;letter-spacing:-.02em}
...
.kb-usage-modal .kb-modal-body{padding:7px 19px 15px;overflow:visible;flex:none;min-height:61px}
...
.kb-usage-modal-foot{justify-content:flex-end;padding:16px 19px;border-top:1px solid var(--line)}.kb-usage-modal-foot .kb-btn{min-width:83px;min-height:31px;padding:5px 12px;font-size:12px}
...
.kb-export-brand-row{display:grid;grid-template-columns:minmax(220px,1fr) minmax(244px,1fr);align-items:center;gap:14px 24px;margin:8px 0 22px}.kb-export-brand-label{grid-column:1 / -1;font-size:var(--fs-xs);font-weight:400;color:var(--text-muted);line-height:1.25}.kb-export-brand-row .kb-export-logo-row,.kb-export-company-input{grid-column:1;min-width:0}.kb-export-company-input{width:100%;max-width:476px;box-sizing:border-box;padding:10px 14px;border:1px solid var(--line);border-radius:7px;background:var(--surface)}.kb-export-brand-row .kb-position-segmented{grid-column:2;display:flex;gap:12px;width:100%;height:56px}.kb-export-brand-row .kb-position-segmented button{flex:1 1 0;box-sizing:border-box;height:56px;padding:0 12px;border:1px solid var(--line);border-radius:7px;background:var(--surface);font-size:var(--fs-sm);white-space:nowrap}.kb-export-brand-row .kb-position-segmented button.is-active{border-color:var(--accent);background:var(--accent-soft);font-weight:var(--fw-semibold)}.kb-export-brand-row .kb-export-logo{width:122px;height:138px}.kb-export-brand-row .kb-brand-remove{width:48px;height:48px;border-radius:8px;font-size:25px}
`;
