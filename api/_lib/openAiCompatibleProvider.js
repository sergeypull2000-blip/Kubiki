...
export function createOpenAiCompatibleClient({ apiKey, fetchImpl = fetch, url, model, timeoutMs = DEEPSEEK_ATTEMPT_TIMEOUT_MS, retries = DEEPSEEK_RETRIES, budget, usageGate, logger = console.info } = {}) {
...
export async function requestOpenAiCompatibleCompletion({ apiKey, url, model, messages, temperature, maxTokens, fetchImpl = fetch, signal } = {}) {
