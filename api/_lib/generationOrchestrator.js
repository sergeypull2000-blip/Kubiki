...
function finalUserPrompt(brief, instruction, personalization, shortlist, budget, pricingMode, performerRateMode, allowPerformerBindings = false) {
  return [
    ...
    "anonymous_named допустим только когда имя конкретного человека, команды или компании явно присутствует в brief/current_user_instruction. Если известна только профессия или роль, возвращай anonymous_unnamed с role и без name. Никогда не копируй профессию или role в name.",
    `<brief>\n${brief}\n</brief>`,
